document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        'welcome-text': {
            ar: 'وجهتك الموثوقة لأجهزة الكمبيوتر المحمول<br>والصيانة والإكسسوارات',
            en: 'Your trusted destination for<br>laptops, repairs, and accessories'
        },
        // ترجمة نصوص الأزرار
        ...
        'btn-map': { ar: 'خرائط جوجل', en: 'Google Map' },
        // ترجمة زر الاتصال
        'btn-phone': { 
        ...
        'footer-text': {
            ...
            ar: 'شكراً لزيارتكم صفحتنا.<br>نحن نقدر دعمكم وثقتكم.<br>© 2025 لابتوب تاون. جميع الحقوق محفوظة.', 
